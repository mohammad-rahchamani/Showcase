...
public class CustomAnalogClock extends View {
    ...
    private void initView(Context context) {
        ...
        mHourHand = ContextCompat.getDrawable(context, R.drawable.clock_hour);
        mMinuteHand = ContextCompat.getDrawable(context, R.drawable.clock_minute);
    ...
    private void onTimeChanged() {
        ...
        mHourInt = mCalendar.get(Calendar.HOUR);
        mMinuteInt = mCalendar.get(Calendar.MINUTE);
        int second = mCalendar.get(Calendar.SECOND);

        mHourInt += (mMinuteInt + mMinuteDiff) / 60;
        mMinuteInt = (mMinuteInt + mMinuteDiff) % 60;

        mMinutes = mMinuteInt + second / 60.0f;
        mHour = mHourInt + mMinutes / 60.0f;
        mChanged = true;
